================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: FileListCreator プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した FileListCreator には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには FileListCreator アプリケーションを構成している各ファイ
ルの概要説明が含まれます。

FileListCreator.vcxproj
...
FileListCreator.vcxproj.filters
...
FileListCreator.h
   ...
   CFileListCreatorApp アプリケーション クラスを宣言します。

FileListCreator.cpp
   これは、アプリケーション クラス CFileListCreatorApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\FileListCreator.ico
   これは、アプリケーションのアイコンとして使用されるアイコンファイルです。この
   アイコンはメイン リソース ファイル FileListCreator.rc に含まれていま
   す。

res\FileListCreator.rc2
...
FileListCreatorDlg.h, FileListCreatorDlg.cpp - ダイアログ
   これらのファイルは CFileListCreatorDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な FileListCreator.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   FileListCreator.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
